    ...
    <div class="content">
            <form method="post" name="myform" id="myform" class="form-qs" onsubmit="return validateAll()">
                ...
                <div class="form-text">
                    ...
                    <input type="text" name="email-new" id="email-new" class="sign-up-input" />
                    <p class="error-email error">
                        Your email must be in this format: _@_._
                        <br/> Example: example@gmail.com'
                    </p>
                </div>
                <div class="form-text">
                ...
                <div class="form-age">
                    ...
                    <div class="radio-option"><input type="radio" name="gender" id="male" value="male"/> Male </div>
                    <div class="radio-option"><input type="radio" name="gender" id="female" value="female"/> Female </div>
                    <div class="radio-option"><input type="radio" name="gender" id="printer" value="printer"/> HP LaserJet Pro P1102 Printer </div>
                    <div class="radio-option"><input type="radio" name="gender" id="other" value="other"/> Other </div>
                </div>
